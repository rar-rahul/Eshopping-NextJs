...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-12 mx-auto ">
    ...
    <div className="lg:w-1/4 md:w-1/2 p-3 mb-2 w-full hover:shadow border border-spacing-1 mx-0" key={product.id}>
        <a className="block rounded overflow-hidden">
          <img alt="ecommerce" className="md:h-[36vh] block  m-auto md:m-0 object-scale-down h-48 w-96" src={product.images[1]}/>
        </a>
        <div className="mt-4">
